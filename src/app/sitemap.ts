...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/sistem`, changeFrequency: "yearly", priority: 0.5 },
    { url: `${base}/faq`, changeFrequency: "weekly", priority: 0.8 },
    { url: `${base}/faq/umum`, changeFrequency: "monthly", priority: 0.5 },
    { url: `${base}/faq/harga`, changeFrequency: "monthly", priority: 0.5 },
    { url: `${base}/faq/sla`, changeFrequency: "monthly", priority: 0.5 },
    { url: `${base}/faq/revisi`, changeFrequency: "monthly", priority: 0.5 },
    { url: `${base}/faq/tiktok`, changeFrequency: "monthly", priority: 0.5 },
    { url: `${base}/faq/video`, changeFrequency: "monthly", priority: 0.5 },
    { url: `${base}/faq/creator`, changeFrequency: "monthly", priority: 0.5 },
    { url: `${base}/faq/seo`, changeFrequency: "monthly", priority: 0.5 },
    { url: `${base}/faq/ig`, changeFrequency: "monthly", priority: 0.5 },

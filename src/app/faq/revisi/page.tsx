...
export default function Page() {
  ...
  <div className="bg-brutalYellow text-ink text-[11px] sm:text-xs font-mono py-2.5 px-3 text-center tracking-tight border-b-2 border-ink flex items-center justify-center gap-2 font-bold relative z-30">
    <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-ink text-brutalYellow text-[10px] uppercase font-mono font-black border border-ink shadow-brutal-sm shrink-0">
      <Icon name="refresh-cw" className="w-3.5 h-3.5" /> KALIBRASI 48 JAM
    </span>
    <span className="truncate sm:overflow-visible text-ink font-bold">Penyesuaian istilah produk, tone of voice, dan sudut pesan gratis maksimal dalam 12 jam kerja.</span>
  </div>
  ...
  <header className="border-b-2 border-ink bg-canvas/95 backdrop-blur-md sticky top-0 z-40">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between gap-4">
      ...
      <a className="flex items-center space-x-2 group shrink-0" href="../index.html">
        ...
        <span className="badge-brutal text-[10px] font-mono uppercase px-2 py-0.5 bg-brutalPink text-ink rounded font-bold">FAQ Garansi</span>
      </a>
  ...
  <div className="py-3 sm:py-3.5 border-b-2 border-ink bg-brutalYellow overflow-hidden relative">
    <div className="flex items-center gap-3 px-4 max-w-7xl mx-auto">
      <div className="marquee-track flex gap-8 font-mono text-xs sm:text-sm font-bold text-ink uppercase tracking-wider whitespace-nowrap shrink-0 items-center">
        <span className="flex items-center gap-1.5"><Icon name="refresh-cw" className="w-4 h-4 text-ink" /> 11 FAQ Revisi & Garansi</span>
        <span>///</span>
        <span className="flex items-center gap-1.5"><Icon name="shield-check" className="w-4 h-4 text-ink" /> Kalibrasi Bebas 48 Jam</span>
        <span>///</span>
        <span className="flex items-center gap-1.5"><Icon name="check-circle-2" className="w-4 h-4 text-ink" /> Kurasi QC Berlapis</span>
        <span>///</span>
        <span className="flex items-center gap-1.5"><Icon name="clock" className="w-4 h-4 text-ink" /> Turnaround Revisi 12 Jam Kerja</span>
        <span>///</span>
        <span className="flex items-center gap-1.5"><Icon name="refresh-cw" className="w-4 h-4 text-ink" /> 11 FAQ Revisi & Garansi</span>
        <span>///</span>
        <span className="flex items-center gap-1.5"><Icon name="shield-check" className="w-4 h-4 text-ink" /> Kalibrasi Bebas 48 Jam</span>
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-10 relative z-10">
      ...
      <section className="hero-plaque p-6 sm:p-10 space-y-4">
        <div className="flex flex-wrap items-center gap-2 font-mono text-xs">
          <span className="badge-brutal text-[10px] uppercase font-bold px-2.5 py-1 bg-brutalPink text-ink rounded-lg">
            11 Pertanyaan Terpilih
          </span>
          <span className="badge-brutal text-[10px] uppercase font-bold px-2.5 py-1 bg-brutalYellow text-ink rounded-lg">
            Kategori: Revisi & Garansi
          </span>
        </div>

        <h1 className="text-3xl sm:text-5xl font-display font-extrabold text-ink tracking-tight leading-[1.15]">
          FAQ Revisi & Garansi — <br className="hidden sm:inline" />
          <span className="bg-brutalYellow text-ink px-3 py-0.5 inline-block -rotate-1 border-2 border-ink shadow-brutal-sm">Jaminan Kalibrasi 48 Jam & QC</span>
        </h1>

        <p className="text-xs sm:text-base text-stone-800 font-sans max-w-3xl leading-relaxed font-medium pt-1">
          Segala rincian mengenai hak kalibrasi naskah selama 48 jam penuh: alur pengajuan revisi istilah produk, turnaround pengerjaan 12 jam kerja, kontrol kualitas QC, hingga batas perlindungan uang kembali.
        </p>
      </section>

      {/* 11 Accordion Questions List */}
      <div className="space-y-4">
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group" open>
          ...
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Kami menyediakan garansi kalibrasi pesan selama 48 jam kalender penuh sejak berkas diserahkan. Jika ada istilah teknis produk, variasi hook pembuka, atau gaya bahasa yang ingin disesuaikan dengan persona tokomu, tim kurator Karsa akan memperbaruinya di Notion OS maksimal dalam kurun waktu 12 jam kerja.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Berapa banyak penyesuaian yang termasuk di dalam garansi kalibrasi?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Garansi mencakup kalibrasi menyeluruh terhadap istilah produk, nada bicara (formal/santai), dan sudut pesan naskah yang belum selaras dengan parameter brief awal. Penyesuaian ini tidak dibatasi kuota kaku selama masih berada di dalam ruang lingkup brief produk yang didaftarkan.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Bagaimana prosedur teknis untuk mengajukan revisi kalibrasi?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Sangat praktis tanpa birokrasi berbelit. Kamu cukup membalas pesan WhatsApp tim operasional atau email penyerahan berkas. Sebutkan nomor hari naskah (misal: Day 04, Day 12) dan bagian mana yang ingin dikalibrasi. Tim copywriter akan langsung memperbarui teks di workspace Notion tokomu.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Apakah Karsa menyediakan garansi pengembalian dana (refund)?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Pengembalian dana 100% berlaku jika pesanan dibatalkan dalam waktu maksimal 1 jam setelah pembayaran sebelum proses riset dimulai oleh tim, atau apabila terjadi kegagalan penyerahan SLA melebihi batas waktu tanpa kompensasi resmi sesuai kebijakan yang tertera di halaman Jaminan SLA & Refund.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Apa perbedaan revisi minor dengan perubahan konsep total?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Revisi kalibrasi mencakup penajaman kata pembuka (hook), penggantian diksi teknis, dan perbaikan alur kalimat. Namun, jika kamu mengganti nama brand toko, berpindah kategori produk secara total, atau mengubah target pasar di tengah jalan, kebutuhan tersebut dianggap sebagai pesanan batch baru.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Apakah pengajuan kalibrasi akan memengaruhi jadwal posting 30 hari saya?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Tidak memengaruhi. Karena turnaround revisi kami sangat cepat (maksimal 12 jam kerja), kamu tetap bisa melanjutkan jadwal rekaman dan penerbitan konten secara paralel tanpa mengorbankan konsistensi posting mingguan tokomu.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Bisakah saya mengajukan kalibrasi lebih dari satu kali dalam 48 jam?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Bisa. Selama masa jendela kalibrasi 48 jam masih aktif, kamu dapat memberikan catatan evaluasi lanjutan kepada tim kami via WhatsApp agar hasil naskah benar-benar nyaman dibaca dan sesuai gaya komunikasimu.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Siapa yang bertugas melakukan kurasi kendali mutu (QC) sebelum naskah dikirim?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Setiap batch diperiksa oleh kurator QC independen di tim Karsa. Tiga parameter mutu yang diaudit mencakup: verifikasi daya tahan hook 0-3 detik, keluwesan bahasa manusia (bukan kalimat robot kaku), dan ketegasan instruksi call to action.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Bagaimana jika saya memerlukan penyesuaian setelah batas waktu 48 jam berakhir?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Seluruh berkas Notion dan Google Docs berada di bawah kendali penuh tokomu, sehingga kamu bebas mengedit teksnya kapan pun secara mandiri. Untuk asistensi penulisan ulang naskah skala besar di luar jendela 48 jam, kamu dapat memesan batch lanjutan.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Apakah kompensasi keterlambatan SLA diberikan secara otomatis?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Ya. Sistem pemantauan kami mencatat waktu transaksi dan pengiriman secara transparan. Jika terjadi keterlambatan dari pihak kami, tautan Notion yang kamu terima akan otomatis sudah dilengkapi dengan 5 naskah video pendek tambahan secara gratis.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Bagaimana jika ada naskah yang performa penontonnya kurang maksimal saat diposting?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Kami menjamin mutu struktur naskah psikologis, hook retensi, dan relevansi SEO. Namun performa views akhir juga dipengaruhi oleh jam posting, kejelasan gestur talent di depan kamera, dan algoritma platform pihak ketiga. Di dalam paket kami sertakan bonus 50 variasi hook alternatif untuk mengganti pembuka video jika diperlukan.
          </p>
        </details>
      ...
      <section className="bento-card p-6 sm:p-8 rounded-3xl bg-brutalYellow text-center space-y-3 shadow-brutal-lg">
        ...
        <h2 className="text-2xl sm:text-3xl font-display font-extrabold text-ink">Ingin Konsultasi Mengenai Garansi Kalibrasi?</h2>
        <p className="text-xs sm:text-sm text-stone-800 font-sans max-w-lg mx-auto leading-relaxed font-medium">
          Tim operasional Karsa siap memastikan seluruh kebutuhan naskahmu terlayani dengan standar SLA terbaik melalui WhatsApp.
        </p>
        <div className="pt-2">
          <a href="https://wa.me/6281288009920?text=Halo%20Karsa%2C%20saya%20mau%20tanya%20seputar%20garansi%20kalibrasi" target="_blank" rel="noopener noreferrer" className="btn-press inline-flex items-center gap-2 px-6 py-3.5 bg-ink text-brutalYellow hover:bg-white hover:text-ink font-mono text-xs sm:text-sm font-bold rounded-xl transition">

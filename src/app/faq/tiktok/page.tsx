...
export default function Page() {
  ...
  <div className="bg-brutalYellow text-ink text-[11px] sm:text-xs font-mono py-2.5 px-3 text-center tracking-tight border-b-2 border-ink flex items-center justify-center gap-2 font-bold relative z-30">
    <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-ink text-brutalYellow text-[10px] uppercase font-mono font-black border border-ink shadow-brutal-sm shrink-0">
      <Icon name="help-circle" className="w-3.5 h-3.5" /> FAQ SCRIPT TIKTOK
    </span>
    <span className="truncate sm:overflow-visible text-ink font-bold">Jawaban detail seputar durasi, naskah kata-per-kata, teleprompter, dan B-roll kamera HP.</span>
  </div>
  ...
  <div className="py-3 sm:py-3.5 border-b-2 border-ink bg-brutalYellow overflow-hidden relative">
    <div className="flex items-center gap-3 px-4 max-w-7xl mx-auto">
      <div className="marquee-track flex gap-8 font-mono text-xs sm:text-sm font-bold text-ink uppercase tracking-wider whitespace-nowrap shrink-0 items-center">
        <span className="flex items-center gap-1.5"><Icon name="clapperboard" className="w-4 h-4 text-ink" /> 8 FAQ Script Video TikTok</span>
        <span>///</span>
        <span className="flex items-center gap-1.5"><Icon name="clock" className="w-4 h-4 text-ink" /> Format 15-30 Detik</span>
        <span>///</span>
  ...
  <main id="main-content" className="flex-1 py-10 sm:py-16 brutal-dots relative overflow-hidden">
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-10 relative z-10">
      ...
      <section className="hero-plaque p-6 sm:p-10 space-y-4">
        <div className="flex flex-wrap items-center gap-2 font-mono text-xs">
          ...
          <span className="badge-brutal text-[10px] uppercase font-bold px-2.5 py-1 bg-brutalYellow text-ink rounded-lg">
            Kategori: Jasa Script Video TikTok
          </span>
        </div>

        <h1 className="text-3xl sm:text-5xl font-display font-extrabold text-ink tracking-tight leading-[1.15]">
          FAQ Jasa Script Video TikTok — <br className="hidden sm:inline" />
          <span className="bg-brutalYellow text-ink px-3 py-0.5 inline-block -rotate-1 border-2 border-ink shadow-brutal-sm">Tanya Jawab Naskah & Produksi</span>
        </h1>

        <p className="text-xs sm:text-base text-stone-800 font-sans max-w-3xl leading-relaxed font-medium pt-1">
          Pertanyaan umum mengenai penulisan naskah TikTok siap baca: format durasi 15-30 detik, arahan gestur visual, shot-list B-roll kamera HP, teleprompter, hingga alur kalibrasi sudut pesan.
        </p>
      </section>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group" open>
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Berapa lama waktu pembuatan 30 script video TikTok ini?</span>
            </div>
          ...
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Seluruh 30 naskah kata-per-kata diserahkan maksimal dalam kurun waktu 1x24 jam kerja setelah formulir brief divalidasi dan pembayaran terkonfirmasi. Setiap naskah sudah lengkap dengan timing per detik, arahan visual, dan direct CTA.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Naskah video dirancang untuk format vertikal berapa detik?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Setiap naskah dirancang untuk format vertikal 9:16 dengan rentang durasi 15-30 detik (ritme optimal algoritma TikTok, Reels, dan Shorts). Struktur dibagi per detik: visual/audio hook (0-3s), problem framing (3-10s), value solution (10-20s), dan call to action (20-25s).
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Apakah saya wajib memiliki tim produksi video khusus?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Tidak perlu sama sekali. Cukup gunakan kamera ponsel biasa dengan pencahayaan jendela alami dan tripod meja. Setiap naskah telah dilengkapi panduan gestur visual, intonasi dialog, dan shot-list B-roll praktis sehingga kamu atau staf tokomu bisa merekamnya secara mandiri.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Apakah gaya naskah bisa disesuaikan dengan karakter brand saya?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Bisa. Tim Karsa membedah parameter brief bisnismu terlebih dahulu: persona pembeli, harga produk, gaya komunikasi, dan kompetitor acuan. Jika ada diksi atau tone yang kurang klop, tersedia garansi kalibrasi 48 jam gratis.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Apakah script TikTok sudah termasuk arahan visual kamera dan B-roll?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Ya. Setiap naskah dilengkapi shot-list: petunjuk sudut kamera, ekspresi wajah talent, teks yang muncul di layar (*on-screen text*), serta footage B-roll produk yang disarankan agar video terlihat dinamis dan tidak membosankan.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Bisakah saya meminta naskah dengan durasi lebih panjang (60 detik)?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Standar formula retensi tinggi kami adalah 25-40 detik karena menghasilkan retensi dan shares tertinggi. Namun, jika kamu membutuhkan naskah 60 detik atau format tutorial panjang, kamu cukup mencantumkannya di kolom catatan brief.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Apakah script ditulis kata-per-kata atau sekadar poin ide kasar?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Ditulis kata-per-kata (*word-for-word*). Kamu bisa menyalinnya langsung ke aplikasi teleprompter di ponsel tanpa perlu menghafal atau mengarang kalimat sendiri saat proses rekaman berlangsung.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Apakah ada panduan cara membaca naskah dengan luwes di depan kamera?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Tersedia. Di dalam workspace Notion Content OS terdapat modul panduan rekaman mandiri: tips mengatasi demam panggung, cara melatih kontak mata ke lensa kamera, dan teknik intonasi bicara natural untuk pemula.
          </p>
        </details>
      ...
      <section className="bento-card p-6 sm:p-8 rounded-3xl bg-brutalYellow text-center space-y-3 shadow-brutal-lg">
        ...
        <h2 className="text-2xl sm:text-3xl font-display font-extrabold text-ink">Butuh Diskusi Seputar Format Naskah Tokomu?</h2>
        <p className="text-xs sm:text-sm text-stone-800 font-sans max-w-lg mx-auto leading-relaxed font-medium">
          Tim copywriter Karsa siap membantu menganalisis gaya bicara yang paling pas untuk niche bisnismu via WhatsApp.
        </p>
        <div className="pt-2">
          <a href="https://wa.me/6281288009920?text=Halo%20Karsa%2C%20saya%20mau%20tanya%20seputar%20script%20video%20TikTok" target="_blank" rel="noopener noreferrer" className="btn-press inline-flex items-center gap-2 px-6 py-3.5 bg-ink text-brutalYellow hover:bg-white hover:text-ink font-mono text-xs sm:text-sm font-bold rounded-xl transition">

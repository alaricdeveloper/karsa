...
export default function Page() {
  ...
  <div className="bg-brutalYellow text-ink text-[11px] sm:text-xs font-mono py-2.5 px-3 text-center tracking-tight border-b-2 border-ink flex items-center justify-center gap-2 font-bold relative z-30">
    <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-ink text-brutalYellow text-[10px] uppercase font-mono font-black border border-ink shadow-brutal-sm shrink-0">
      <Icon name="help-circle" className="w-3.5 h-3.5" /> FAQ VIDEO UMKM
    </span>
    <span className="truncate sm:overflow-visible text-ink font-bold">Jawaban lengkap seputar format naskah, alat rekam HP, platform, dan kalender 30 hari.</span>
  </div>
  ...
  <div className="py-3 sm:py-3.5 border-b-2 border-ink bg-brutalYellow overflow-hidden relative">
    <div className="flex items-center gap-3 px-4 max-w-7xl mx-auto">
      <div className="marquee-track flex gap-8 font-mono text-xs sm:text-sm font-bold text-ink uppercase tracking-wider whitespace-nowrap shrink-0 items-center">
        <span className="flex items-center gap-1.5"><Icon name="help-circle" className="w-4 h-4 text-ink" /> 7 Tanya Jawab Video UMKM</span>
        <span>///</span>
        <span className="flex items-center gap-1.5"><Icon name="smartphone" className="w-4 h-4 text-ink" /> Cukup Modal Kamera HP</span>
        <span>///</span>
  ...
  <main id="main-content" className="flex-1 py-10 sm:py-16 brutal-dots relative overflow-hidden">
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-10 relative z-10">
      ...
      <section className="hero-plaque p-6 sm:p-10 space-y-4">
        <div className="flex flex-wrap items-center gap-2 font-mono text-xs">
          ...
          <span className="badge-brutal text-[10px] uppercase font-bold px-2.5 py-1 bg-brutalYellow text-ink rounded-lg">
            Kategori: Konten Video UMKM
          </span>
        </div>

        <h1 className="text-3xl sm:text-5xl font-display font-extrabold text-ink tracking-tight leading-[1.15]">
          FAQ Jasa Konten Video UMKM — <br className="hidden sm:inline" />
          <span className="bg-brutalYellow text-ink px-3 py-0.5 inline-block -rotate-1 border-2 border-ink shadow-brutal-sm">Pertanyaan Produksi & Eksekusi</span>
        </h1>

        <p className="text-xs sm:text-base text-stone-800 font-sans max-w-3xl leading-relaxed font-medium pt-1">
          Pahami bagaimana sistem naskah 30 hari Karsa bekerja untuk bisnismu: perbedaan dengan jasa shooting di lokasi, dukungan platform video vertikal, kebutuhan alat perekaman, hingga funnel penjualan ke DM.
        </p>
      </section>
      ...
      <div className="space-y-4">
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group" open>
          ...
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Kami menyediakan sistem konten menyeluruh (naskah kata-per-kata per detik, caption AIDA, artikel SEO, dan database Notion OS), bukan mengirimkan kru kamera ke lokasimu. Kamu atau staf tokomu merekam mandiri memakai HP mengikuti instruksi visual dan shot-list yang sudah kami siapkan.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Paket ini cocok untuk jenis bisnis seperti apa?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Sangat cocok untuk UMKM produk fisik maupun jasa (Kuliner/F&B, Skincare, Fashion, Edukasi, dan Konsultan) yang sudah siap berjualan, mampu merekam menggunakan kamera HP, dan membutuhkan konsistensi posting 30 hari tanpa harus pusing memikirkan ide dari nol tiap minggu.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Platform media sosial apa saja yang didukung oleh naskah ini?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Format naskah adalah vertikal 9:16 durasi 15-30 detik yang universal untuk TikTok, Instagram Reels, dan YouTube Shorts. Caption AIDA yang kami sertakan juga langsung kompatibel untuk postingan Instagram, Facebook, dan Threads.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Apakah paket konten video UMKM ini sudah termasuk proses editing video?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Tidak — fokus layanan kami adalah penyusunan strategi sudut pesan, naskah dialog per detik, caption, dan sistem Notion OS. Kamu merekam sendiri memakai HP dan dapat mengeditnya secara cepat memakai aplikasi gratis seperti CapCut sesuai panduan visual yang telah kami sertakan.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Apakah naskah ini bisa diadaptasi untuk konten YouTube?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Bisa. Jika target utamamu adalah YouTube Shorts, naskah 15-30s bisa langsung dieksekusi. Jika memerlukan YouTube format horizontal (long-form), kamu bisa mencantumkannya saat mengisi brief agar struktur value delivery disesuaikan.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Apakah ada contoh nyata atau pratinjau hasil naskah yang bisa saya lihat?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Contoh struktur naskah per detik dan caption AIDA dapat kamu lihat di beranda (bagian Pratinjau Kualitas & Spesimen Output). Untuk melihat contoh studi kasus spesifik pada industrimu, hubungi tim kami via WhatsApp.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Apakah saya perlu mengirimkan produk fisik atau aset foto ke studio Karsa?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Tidak perlu mengirimkan barang fisik. Tim copywriter menyusun naskah berdasarkan deskripsi pada formulir brief dan link media sosial tokomu. Jika kamu memiliki foto produk atau katalog digital, kamu cukup melampirkannya saat mengisi form brief.
          </p>
        </details>
      ...
      <section className="bento-card p-6 sm:p-8 rounded-3xl bg-brutalYellow text-center space-y-3 shadow-brutal-lg">
        ...
        <h2 className="text-2xl sm:text-3xl font-display font-extrabold text-ink">Ada Pertanyaan yang Belum Terjawab?</h2>
        <p className="text-xs sm:text-sm text-stone-800 font-sans max-w-lg mx-auto leading-relaxed font-medium">
          Tim operasional Karsa siap berdiskusi langsung mengenai kecocokan format video untuk bisnismu via WhatsApp.
        </p>
        <div className="pt-2">
          <a href="https://wa.me/6281288009920?text=Halo%20Karsa%2C%20saya%20mau%20tanya%20seputar%20jasa%20konten%20video%20UMKM" target="_blank" rel="noopener noreferrer" className="btn-press inline-flex items-center gap-2 px-6 py-3.5 bg-ink text-brutalYellow hover:bg-white hover:text-ink font-mono text-xs sm:text-sm font-bold rounded-xl transition">

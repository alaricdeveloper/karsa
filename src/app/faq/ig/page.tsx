...
export default function Page() {
  ...
  <div className="bg-brutalYellow text-ink text-[11px] sm:text-xs font-mono py-2.5 px-3 text-center tracking-tight border-b-2 border-ink flex items-center justify-center gap-2 font-bold relative z-30">
    <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-ink text-brutalYellow text-[10px] uppercase font-mono font-black border border-ink shadow-brutal-sm shrink-0">
      <Icon name="help-circle" className="w-3.5 h-3.5" /> FAQ INSTAGRAM REELS
    </span>
    <span className="truncate sm:overflow-visible text-ink font-bold">Jawaban lengkap seputar paket Instagram Reels, caption AIDA, bio & highlight, dan kalender 30 hari.</span>
  </div>
  ...
  <header className="border-b-2 border-ink bg-canvas/95 backdrop-blur-md sticky top-0 z-40">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between gap-4">
      ...
      <a className="flex items-center space-x-2 group shrink-0" href="../index.html">
        ...
        <span className="badge-brutal text-[10px] font-mono uppercase px-2 py-0.5 bg-brutalPink text-ink rounded font-bold">FAQ Instagram</span>
      </a>
  ...
  <div className="py-3 sm:py-3.5 border-b-2 border-ink bg-brutalYellow overflow-hidden relative">
    <div className="flex items-center gap-3 px-4 max-w-7xl mx-auto">
      <div className="marquee-track flex gap-8 font-mono text-xs sm:text-sm font-bold text-ink uppercase tracking-wider whitespace-nowrap shrink-0 items-center">
        <span className="flex items-center gap-1.5"><Icon name="instagram" className="w-4 h-4 text-ink" /> 8 Tanya Jawab Konten Instagram</span>
        <span>///</span>
        <span className="flex items-center gap-1.5"><Icon name="video" className="w-4 h-4 text-ink" /> 30 Script Reels 9:16</span>
        <span>///</span>
        <span className="flex items-center gap-1.5"><Icon name="message-square" className="w-4 h-4 text-ink" /> Caption AIDA & Riset Tagar</span>
        <span>///</span>
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-10 relative z-10">
      ...
      <section className="hero-plaque p-6 sm:p-10 space-y-4">
        <div className="flex flex-wrap items-center gap-2 font-mono text-xs">
          ...
          <span className="badge-brutal text-[10px] uppercase font-bold px-2.5 py-1 bg-brutalPink text-ink rounded-lg">
            Kategori: Paket Konten Instagram
          </span>
        </div>

        <h1 className="text-3xl sm:text-5xl font-display font-extrabold text-ink tracking-tight leading-[1.15]">
          FAQ Paket Konten Instagram — <br className="hidden sm:inline" />
          <span className="bg-brutalYellow text-ink px-3 py-0.5 inline-block -rotate-1 border-2 border-ink shadow-brutal-sm">Reels, Caption AIDA, & Feed</span>
        </h1>

        <p className="text-xs sm:text-base text-stone-800 font-sans max-w-3xl leading-relaxed font-medium pt-1">
          Segala hal yang perlu kamu ketahui seputar strategi Instagram UMKM: apakah mencakup desain grafis, frekuensi posting ideal mingguan, riset tagar 3-tier, pemanfaatan Instagram Story, hingga alur repost ke platform lain.
        </p>
      </section>
      ...
      <div className="space-y-4">
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group" open>
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Apakah paket ini termasuk desain visual feed atau template foto produk?</span>
            </div>
          ...
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Fokus utama paket ini adalah konten video Reels 9:16 kata-per-kata + copywriting caption AIDA + kalender editorial 30 hari di Notion OS, bukan desain gambar statis di Photoshop/Canva. Format video Reels adalah mesin jangkauan audiens baru paling efektif di Instagram saat ini, dan panduan bio/highlight kami memastikan profilmu langsung profesional saat dikunjungi orang baru.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          ...
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Kalender Karsa dirancang untuk ritme 30 hari (1 konten per hari). Untuk efisiensi waktu, kamu cukup merekam 4-6 naskah sekaligus di akhir pekan menggunakan kamera ponsel, lalu mengeditnya secara cepat di CapCut dan menjadwalkannya otomatis lewat Meta Business Suite.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Apakah caption dan tagar risetnya sudah spesifik sesuai produk toko saya?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Ya, seluruh 30 caption ditulis berdasarkan brief produk tokomu menggunakan struktur AIDA (Attention, Interest, Desire, Action). Riset tagar juga dikelompokkan dalam 3 tingkatan (tagar besar/broad, tagar menengah/niche, dan tagar mikro konversi) untuk mengoptimalkan algoritma pencarian Explore Instagram.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Bagaimana dengan kebutuhan konten Instagram Story?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Di dalam paket sudah disertakan Content Repurposing Framework. Panduan ini menjelaskan langkah mudah memecah 1 naskah Reels menjadi 3-4 interaksi Instagram Story (stiker polling, tanya jawab, atau behind the scenes ringkas) tanpa perlu mengarang ide baru dari nol.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Apakah paket Instagram ini menyediakan template karusel?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Paket ini menyediakan struktur copy slide-by-slide untuk konten edukasi (headline slide 1, penjabaran slide 2-4, dan slide penutup CTA). Desain visual karusel dapat kamu buat mandiri memakai template Canva toko mengikuti teks yang telah kami sediakan.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Apakah naskah Reels Instagram ini bisa saya repost ke TikTok?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Sangat bisa. Format 9:16 durasi 15-30 detik adalah format universal yang langsung cocok untuk TikTok, Instagram Reels, dan YouTube Shorts. Kamu hanya perlu mengunggah video yang sama ke TikTok dengan menyesuaikan musik latar dan teks sampulnya.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Apakah ada fitur penjadwalan otomatis untuk mengunggah konten?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Kami tidak meminta akses login akun Instagram Klien demi keamanan privasi. Kamu menerima kalender Notion OS lengkap dengan rekomendasi jam tayang dan caption siap salin, yang bisa kamu jadwalkan secara gratis lewat aplikasi resmi Meta Business Suite.
          </p>
        </details>
        ...
        <details className="bento-card rounded-2xl bg-white p-5 cursor-pointer list-none group">
          <summary className="flex justify-between items-center gap-3 font-display font-bold text-sm sm:text-base text-ink">
            <div className="flex items-center gap-3">
              ...
              <span>Berapa banyak tagar yang disarankan per postingan?</span>
            </div>
            <span className="font-mono text-base font-bold text-ink group-open:rotate-45 transition-transform shrink-0">+</span>
          </summary>
          <p className="text-xs sm:text-sm text-stone-700 mt-3 pl-10 leading-relaxed font-sans border-t-2 border-sand pt-3">
            Kami menyertakan 10-15 tagar kurasi per naskah yang terbagi ke dalam 3 tier: 3 tagar industri besar (broad), 5 tagar kategori produk spesifik (medium), dan 3-5 tagar niche/lokal untuk mempermudah postinganmu ditemukan oleh calon pembeli yang tepat.
          </p>
        </details>
      ...
      <section className="bento-card p-6 sm:p-8 rounded-3xl bg-brutalYellow text-center space-y-3 shadow-brutal-lg">
        ...
        <h2 className="text-2xl sm:text-3xl font-display font-extrabold text-ink">Ingin Membedah Akun Instagram Tokomu?</h2>
        <p className="text-xs sm:text-sm text-stone-800 font-sans max-w-lg mx-auto leading-relaxed font-medium">
          Tim strategist Karsa siap berdiskusi langsung mengenai penataan bio dan alur Reels tokomu via WhatsApp.
        </p>
        <div className="pt-2">
          <a href="https://wa.me/6281288009920?text=Halo%20Karsa%2C%20saya%20mau%20tanya%20seputar%20paket%20konten%20Instagram" target="_blank" rel="noopener noreferrer" className="btn-press inline-flex items-center gap-2 px-6 py-3.5 bg-ink text-brutalYellow hover:bg-white hover:text-ink font-mono text-xs sm:text-sm font-bold rounded-xl transition">

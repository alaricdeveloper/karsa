              ...
              <div className="bento-pop rounded-3xl bg-white p-5 sm:p-8 lg:p-9">
                  ...
                  <div className="mb-5 space-y-2.5">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                      ...
                      <button
                        ...
                        disabled={loading}
                        className="w-full py-3 rounded-xl border-2 border-ink bg-ink hover:bg-terracotta text-ink font-mono text-sm font-bold transition flex items-center justify-center gap-2 min-h-[44px] shadow-brutal-sm disabled:opacity-60 disabled:cursor-wait"
                      >
                ...
                <form onSubmit={handleSubmit} className="space-y-4" aria-busy={loading}>
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full min-h-[50px] py-3.5 bg-terracotta hover:bg-ink text-ink hover:text-white rounded-2xl border-2 border-ink shadow-brutal font-mono text-sm font-bold flex items-center justify-center gap-2 transition disabled:opacity-60 disabled:cursor-wait"
                  >
                    {loading ? (
                      <span

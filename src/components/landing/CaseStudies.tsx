      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          <div className="bento-pop p-5 sm:p-8 rounded-3xl bg-canvas">
            ...
            <p className="text-xs text-stone-600 mt-2 leading-relaxed font-sans">Sebelumnya mengunggah foto katalog tanpa cerita. Setelah beralih ke 30 video script Karsa, konten diarahkan ke detail bahan dan panduan fitting tubuh.</p>
            <div className="mt-6 pt-4 border-t-2 border-ink grid grid-cols-2 gap-2 font-mono text-xs">
              <div><span className="text-stone-500 block text-[10px]">Saves rate</span><span className="text-ink font-bold text-base font-serif">+240%</span></div>
              <div><span className="text-stone-500 block text-[10px]">Waktu produksi</span><span className="text-terracotta font-bold text-base font-serif">Turun 80%</span></div>
            </div>
          </div>
          ...
          <div className="bento-pop p-5 sm:p-8 rounded-3xl bg-canvas">
            ...
            <p className="text-xs text-stone-600 mt-2 leading-relaxed font-sans">Kalender konten diisi dengan naskah edukasi seputar pH kopi dan artikel SEO yang menjawab pertanyaan calon pembeli.</p>
            <div className="mt-6 pt-4 border-t-2 border-ink grid grid-cols-2 gap-2 font-mono text-xs">
              <div><span className="text-stone-500 block text-[10px]">Traffic Google</span><span className="text-ink font-bold text-base font-serif">1.800+/bln</span></div>
              <div><span className="text-stone-500 block text-[10px]">Posting teratur</span><span className="text-terracotta font-bold text-base font-serif">30 hari penuh</span></div>
            </div>
          </div>
        </div>

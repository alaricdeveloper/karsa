...
export function TopBanner() {
  return (
<div className="bg-terracotta text-ink text-[11px] sm:text-xs font-mono py-2 sm:py-2.5 px-3 text-center tracking-tight border-b-2 border-ink flex items-center justify-center gap-1.5 sm:gap-2 font-bold">

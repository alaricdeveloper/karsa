      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-14 items-start">
          <div className="lg:col-span-4">
            ...
            <h2 className="text-2xl sm:text-4xl font-serif text-ink mt-3 leading-tight">
              Setiap hari punya peran dalam kalender.
            </h2>
            <p className="text-xs sm:text-sm text-stone-600 font-sans mt-3 leading-relaxed">
              30 hari konten disusun sebagai rangkaian: kenalkan masalah, bangun kepercayaan, tunjukkan solusi, lalu arahkan audiens ke langkah berikutnya.
            </p>
            <a href="#preview" className="inline-flex items-center gap-2 mt-5 text-xs font-mono font-bold text-terracotta hover:underline">
              Lihat contoh output lengkap <span aria-hidden="true">&rarr;</span>
            </a>
          </div>

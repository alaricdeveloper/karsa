    ...
    <section id="compare-scripts" className="py-12 sm:py-20 border-b-2 border-ink bg-surface">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-10">
          ...
          <h2 className="text-2xl sm:text-4xl font-serif text-ink mt-2">Script Biasa vs Formula Psikologi Karsa</h2>
          <p className="text-xs sm:text-sm text-stone-600 font-mono mt-1">Kami tidak memakai prompt AI mentah yang kaku. Tiap detik dioptimasi untuk menahan scroll.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 font-mono text-xs">
          ...
          <div className="bento-pop p-5 sm:p-6 rounded-3xl bg-rose-50/50 space-y-3 sm:space-y-4">
            <div className="flex justify-between items-center pb-2.5 border-b-2 border-ink">
              ...
              <span className="text-rose-700 font-bold">Retensi 2s</span>
            </div>
            ...
            <p className="text-[11px] font-bold text-rose-800 pt-2 border-t-2 border-ink">Hasil: Penonton langsung scroll lewat dalam 2 detik pertama.</p>
          </div>
          ...
          <div className="bento-pop p-5 sm:p-6 rounded-3xl bg-wasabi/30 space-y-3 sm:space-y-4">
            <div className="flex justify-between items-center pb-2.5 border-b-2 border-ink">
              ...
              <span className="text-ink font-bold">Retensi 85%</span>
            </div>
            ...
            <p className="text-[11px] font-bold text-ink pt-2 border-t-2 border-ink">Hasil: Penonton nonton sampai tuntas dan langsung klik link di bio.</p>
          </div>

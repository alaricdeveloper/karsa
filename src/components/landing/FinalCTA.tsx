      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="bento-pop rounded-3xl p-6 sm:p-10 bg-terracotta text-white flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="shrink-0 md:text-right">
            ...
            <a href="#order" className="mt-4 inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-ink text-canvas font-mono text-xs font-bold hover:bg-wasabi hover:text-ink transition shadow-brutal-sm">
              Isi brief sekarang <ArrowRight className="w-4 h-4" aria-hidden="true" />
            </a>
          </div>
        </div>
      </div>
